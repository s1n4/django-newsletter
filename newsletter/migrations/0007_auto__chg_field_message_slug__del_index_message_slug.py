...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.slug'
        db.alter_column(u'newsletter_message', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Removing index on 'Message', fields ['slug']
        db.delete_index(u'newsletter_message', ['slug'])


    def backwards(self, orm):
        # Adding index on 'Message', fields ['slug']
        db.create_index(u'newsletter_message', ['slug'])


        # Changing field 'Message.slug'
        db.alter_column(u'newsletter_message', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

    models = {
        u'accounts.account': {
            'Meta': {'object_name': 'Account'},
            'address': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'cart': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['accounts.Cart']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.cart': {
            ...
            'cart_items': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.CartItem']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'accounts.cartitem': {
        ...
        u'newsletter.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 9, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'newsletter.subscription': {
            ...
            'activation_code': ('django.db.models.fields.CharField', [], {'default': "'6f25f4b688da86d9779f23e573d1abd11c8b12c9'", 'max_length': '40'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Account']", 'null': 'True', 'blank': 'True'})
        },
        u'products.product': {
            'Meta': {'object_name': 'Product'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['categories.Category']"}),
            'color': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '8', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {}),
            'homepage_thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'title1': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})
        },
        u'sites.site': {
